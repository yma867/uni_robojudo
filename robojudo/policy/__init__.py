...
policy_registry.add("LocoModePolicy", ".locomode_policy")
policy_registry.add("MotionTrackingPolicy", ".motion_tracking_policy")
policy_registry.add("MimicKitPolicy", ".mimickit_policy")